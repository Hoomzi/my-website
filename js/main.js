document.addEventListener('DOMContentLoaded', function() {
  ...
  const translations = {
    ...
    fa: {
      ...
      faq_q7: "هزینه طراحی سایت چقدر است؟",
      faq_a7: "هزینه طراحی سایت به فاکتورهای مختلفی از جمله پیچیدگی پروژه، امکانات درخواستی و میزان زمان و تخصص لازم برای پیاده‌سازی یک راهکار اختصاصی متناسب با نیاز شما بستگی دارد."
    }
  };
